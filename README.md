...
Unlock abilities from chests you get for surviving waves, pick and choose which ones you want to use. Currently there are 18 player abilities in total.
...
### Player abilities
There are currently 18 abilities usable by the player. Their types are essentially their themes.
