...
Geoslayer is a 2D wave-based game with simple graphics. You use your 2 abilities to defeat incoming enemies. You also have a dashing ability you can use to dodge incoming attacks. Beat the boss who spawns at the end to win.
...
Your permament level is important when entering different worlds. Every world will have a level requirement (except for World 1).
...
![Abilities](./docs/screenshots/abilities.gif)
