...
## Scene instantiated when spawning the player.
var player_scene: PackedScene = preload("res://scenes/characters/player/player_character.tscn")
## The player currently loaded in the world.
...
## Connects the player's important signals to functions inside this class.
...
## Attempts to spend and apply a perk point to a given CharacterStat.
